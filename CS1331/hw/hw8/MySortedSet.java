...
public class MySortedSet<E extends Comparable<? super E>>
    ...
    public MySortedSet<E> filter(Predicate<E> p) {
        ...
        .collect(Collectors.toCollection(() -> new MySortedSet<E>(c)));
    }
    ...
    public MySortedSet<E> tailSet(E fromElement) {
        return list.subList(list.indexOf(fromElement), list.size() - 1).stream()
            .collect(Collectors.toCollection(() -> new MySortedSet<E>(c)));
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.size(); i++) {
            representation += list.get(i).toString() + "\n";
        }
